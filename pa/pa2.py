...
def buildInsert(table,cols,values):
...
with open("movie.txt","w") as f:
    for item in items:
        ...
        try:
            ...
            execute(buildInsert("movie",["title","region","director","actors","rate"],[item['data-title'],item['data-region'],item['data-director'],item['data-actors'],item['data-rate']]))
