#-*-coding:utf-8-*-
from PyQt5.QtWidgets import QDialog, QListWidget, QFrame, QStackedWidget, QHBoxLayout, QPushButton, QVBoxLayout, QLabel, \
    QWidget, QLineEdit, QComboBox, QTextEdit, QGridLayout, QCheckBox, QApplication, QLayout
